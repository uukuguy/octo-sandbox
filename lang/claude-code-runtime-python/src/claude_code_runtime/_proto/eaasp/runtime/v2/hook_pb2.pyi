...
class HookEvent(_message.Message):
    __slots__ = ("session_id", "request_id", "event_type", "timestamp", "pre_tool_call", "post_tool_result", "stop", "session_start", "session_end", "pre_policy_deploy", "pre_approval", "event_received")
    ...
    def __init__(self, session_id: _Optional[str] = ..., request_id: _Optional[str] = ..., event_type: _Optional[_Union[_runtime_pb2.HookEventType, str]] = ..., timestamp: _Optional[str] = ..., pre_tool_call: _Optional[_Union[PreToolCallHook, _Mapping]] = ..., post_tool_result: _Optional[_Union[PostToolResultHook, _Mapping]] = ..., stop: _Optional[_Union[StopHook, _Mapping]] = ..., session_start: _Optional[_Union[SessionStartHook, _Mapping]] = ..., session_end: _Optional[_Union[SessionEndHook, _Mapping]] = ..., pre_policy_deploy: _Optional[_Union[PrePolicyDeployHook, _Mapping]] = ..., pre_approval: _Optional[_Union[PreApprovalHook, _Mapping]] = ..., event_received: _Optional[_Union[EventReceivedHook, _Mapping]] = ...) -> None: ...
