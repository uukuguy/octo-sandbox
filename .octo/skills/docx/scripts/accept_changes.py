...
LIBREOFFICE_PROFILE = tempfile.mkdtemp(prefix="lo_docx_profile_")
...
def _setup_libreoffice_macro() -> bool:
    ...
    if not macro_dir.exists():
        try:
            ...
            print(
                f"Warning: LibreOffice profile init timed out for {LIBREOFFICE_PROFILE}",
                file=sys.stderr,
            )
    ...
    try:
        ...
        print(
            f"Error: Failed to write macro file {macro_file}: {e}",
            file=sys.stderr,
        )
        return False
